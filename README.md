...
We use entropy (e >= 0.65) and 1-0 ratio (0.375 <= r <= 0.625) to determine 
Since we only care about the addresses likely generated by SLAAC with pricvacy extensions, the script writes all the entries with addresses likely generated 
